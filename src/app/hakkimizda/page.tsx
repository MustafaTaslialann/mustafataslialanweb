...
export default function Hakkimizda() {
  return (
    <main className="flex flex-col min-h-screen p-6 bg-[#0A1D56] text-yellow-400">
      <h1 className="text-3xl font-bold mb-4 text-yellow-300">Hakkımızda</h1>
      <p className="mb-4 text-yellow-200">
        Beyaz Eşya Servisi olarak yıllardır garantisi olmayan cihazlarınıza profesyonel bakım ve onarım hizmeti sunmaktayız.
      </p>
      <p className="mb-4 text-yellow-200">
        Müşteri memnuniyeti önceliğimizdir. Uzman teknisyenlerimizle en iyi hizmeti vermek için çalışıyoruz.
      </p>
      <div>
